...
! function (a, b) {
    ...
    ! function (a) {
        ...
        a.valHooks.select.set = function (b, c) {
            return c && !i.useDefault && a(b).data("selected", !0), i._set.apply(this, arguments)
        };
        var j = null,
            k = function () {
                try {
        ...
        a.fn.triggerNative = function (a) {
            var b, c = this[0];
            c.dispatchEvent ? (k ? b = new Event(a, {
                bubbles: !0
        ...
        var t = {
            ...
            w = (new RegExp(r.ENTER + "|" + r.SPACE), function (b, c) {
                var d = this;
                i.useDefault || (a.valHooks.select.set = i._set, i.useDefault = !0), this.$element = a(b), this.$newElement = null, this.$button = null, this.$menu = null, this.options = c, this.selectpicker = {
                    main: {
                        map: {
                            newIndex: {},
                            originalIndex: {}
        ...
        w.VERSION = "1.13.0-beta", w.DEFAULTS = {
            ...
            windowPadding: 0,
            virtualScroll: 600
        }, "4" === s.major && (w.DEFAULTS.style = "btn-light", w.DEFAULTS.iconBase = "", w.DEFAULTS.tickIcon = "bs-ok-default"), w.prototype = {
            constructor: w,
            init: function () {
                var a = this,
            ...
            createLi: function () {
                ...
                var n = function (a, b, c, d) {
                    ...
                    p = function (a, b, c) {
                        ...
                        return a && (11 === a.nodeType ? d.appendChild(a) : d.insertAdjacentHTML("beforeend", a)), void 0 !== b & "" !== b && (d.className = b), "4" === s.major && d.classList.add("dropdown-item"), c && d.setAttribute("style", c), d
                    },
                    q = function (a) {
                ...
                w.each(function (k) {
                    ...
                    if (j++, !l.hasClass("bs-title-option")) {
                        ...
                        if (!0 === u.hidden || c.options.hideDisabled && (H && !F || G)) {
                            ...
                            return void(I && "divider" !== g[g.length - 1].type && (j++, d.push(n(!1, 0, t.DIVIDER, h + "div")), g.push({
                                type: "divider",
                                optID: h,
                                originalIndex: k
                            })))
                        ...
                        if (F && !0 !== u.divider) {
                            ...
                            if (!this.previousElementSibling) {
                                ...
                                var N = E.label,
                                    ...
                                    P = J.subtext,
                                    Q = J.icon;
                                0 !== k && d.length > 0 && (j++, d.push(n(!1, 0, t.DIVIDER, h + "div")), g.push({
                                    type: "divider",
                                    optID: h,
                                    originalIndex: k
                                })), j++;
                            ...
                            s = q({
                                ...
                                optionSubtext: B,
                                optionIcon: C
                            }), d.push(n(p(s, "opt " + v + M, x), 0, "", h)), g.push({
                                content: z,
                                subtext: B,
                                tokens: A,
                                type: "option",
                        ...
                        } else if (!0 === u.divider) d.push(n(!1, 0, "divider")), g.push({
                            type: "divider",
                            originalIndex: k
                        });
                        else {
                            ...
                            I && "divider" !== g[g.length - 1].type && (j++, d.push(n(!1, 0, t.DIVIDER, h + "div")), g.push({
                                type: "divider",
                                optID: h,
                                originalIndex: k
                            })), s = q({
            ...
            liHeight: function (b) {
                if (b || !1 !== this.options.size && !this.sizeInfo) {
                    ...
                    var r, u = k.offsetHeight,
                        ...
                        D = B ? null : a(e),
                        E = {
                            vert: d(B ? B.paddingTop : D.css("paddingTop")) + d(B ? B.paddingBottom : D.css("paddingBottom")) + d(B ? B.borderTopWidth : D.css("borderTopWidth")) + d(B ? B.borderBottomWidth : D.css("borderBottomWidth")),
                            horiz: d(B ? B.paddingLeft : D.css("paddingLeft")) + d(B ? B.paddingRight : D.css("paddingRight")) + d(B ? B.borderLeftWidth : D.css("borderLeftWidth")) + d(B ? B.borderRightWidth : D.css("borderRightWidth"))
                        },
                        F = {
                            vert: E.vert + d(B ? B.marginTop : D.css("marginTop")) + d(B ? B.marginBottom : D.css("marginBottom")) + 2,
                            horiz: E.horiz + d(B ? B.marginLeft : D.css("marginLeft")) + d(B ? B.marginRight : D.css("marginRight")) + 2
                        };
            ...
            setMenuSize: function (a) {
                ...
                "auto" === this.options.dropdownAlignRight && this.$menu.toggleClass(t.MENURIGHT, this.sizeInfo.selectOffsetLeft > this.sizeInfo.selectOffsetRight && this.sizeInfo.selectOffsetRight < this.$menu[0].offsetWidth - i), this.$menu.css({
                    "max-height": f + "px",
                    overflow: "hidden",
                    "min-height": d + "px"
                }), this.$menuInner.css({
            ...
            selectPosition: function () {
                ...
                var b, c, d, e = this,
                    ...
                    g = function (a) {
                        var g = {};
                        e.$bsContainer.addClass(a.attr("class").replace(/form-control|fit-width/gi, "")).toggleClass(t.DROPUP, a.hasClass(t.DROPUP)), b = a.offset(), f.is("body") ? c = {
                            top: 0,
                            left: 0
                        } : (c = f.offset(), c.top += parseInt(f.css("borderTopWidth")) - f.scrollTop(), c.left += parseInt(f.css("borderLeftWidth")) - f.scrollLeft()), d = a.hasClass(t.DROPUP) ? 0 : a[0].offsetHeight, s.major < 4 && (g.top = b.top - c.top + d, g.left = b.left - c.left), g.width = a[0].offsetWidth, e.$bsContainer.css(g)
                    };
                this.$button.on("click.bs.dropdown.data-api", function () {
                    e.isDisabled() || (g(e.$newElement), e.$bsContainer.appendTo(e.options.container).toggleClass(t.SHOW, !e.$button.hasClass(t.SHOW)).append(e.$menu))
            ...
            checkDisabled: function () {
                var a = this;
                this.isDisabled() ? (this.$newElement.addClass(t.DISABLED), this.$button.addClass(t.DISABLED).attr("tabindex", -1).attr("aria-disabled", !0)) : (this.$button.hasClass(t.DISABLED) && (this.$newElement.removeClass(t.DISABLED), this.$button.removeClass(t.DISABLED).attr("aria-disabled", !1)), -1 != this.$button.attr("tabindex") || this.$element.data("tabindex") || this.$button.removeAttr("tabindex")), this.$button.click(function () {
                    return !a.isDisabled()
                })
            },
            ...
            clickListener: function () {
                ...
                c.data("spaceSelect", !1), this.$button.on("keyup", function (a) {
                    ...
                    s.major > 3 && !b.dropdown && (b.dropdown = b.$button.data("bs.dropdown"), b.dropdown._menu = b.$menu[0])
                }), this.$button.on("click.bs.dropdown.data-api", function () {
                        ...
                        if (b.multiple) {
                            if (m.prop("selected", !n), g === b.activeIndex && (d = !0), d || (b.prevActiveIndex = b.activeIndex, b.activeIndex = void 0), b.setSelected(g, !n), e.blur(), !1 !== p || !1 !== q) {
                                ...
                                if (p && r || q && s)
                                    ...
                                    w[2] && (x = x.replace("{var}", w[2][p > 1 ? 0 : 1]), y = y.replace("{var}", w[2][q > 1 ? 0 : 1])), m.prop("selected", !1), b.$menu.append(z), p && r && (z.append(a("<div>" + x + "</div>")), k = !1, b.$element.trigger("maxReached.bs.select")), q && s && (z.append(a("<div>" + y + "</div>")), k = !1, b.$element.trigger("maxReachedGrp.bs.select")), setTimeout(function () {
                                        b.setSelected(g, !1)
                                    }, 10), z.delay(750).fadeOut(300, function () {
                                        a(this).remove()
                                    })
                                }
                            }
                ...
                }), this.$menu.on("click", "li." + t.DISABLED + " a, .popover-title, .popover-title :not(.close)", function (c) {
                    ...
                    change: function () {
                        b.render(), b.$element.trigger("changed.bs.select", j), j = null
                    },
                    focus: function () {
                        b.$button.focus()
                    }
        ...
        a.fn.selectpicker = f, a.fn.selectpicker.Constructor = w, a.fn.selectpicker.noConflict = function () {
            return a.fn.selectpicker = x, this
        }, a(document).off("keydown.bs.dropdown.data-api").on("keydown.bs.select", '.bootstrap-select [data-toggle="dropdown"], .bootstrap-select [role="listbox"], .bs-searchbox input', w.prototype.keydown).on("focusin.modal", '.bootstrap-select [data-toggle="dropdown"], .bootstrap-select [role="listbox"], .bs-searchbox input', function (a) {
            a.stopPropagation()
